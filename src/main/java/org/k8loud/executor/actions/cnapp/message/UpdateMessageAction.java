...
public class UpdateMessageAction extends MessageAction {
    private String key;
    private String content;

    public UpdateMessageAction(Params params, MessageService messageService) throws ActionException {
    ...
    protected Map<String, Object> executeBody() throws CustomException {
        return messageService.updateMessage(applicationUrl, key, content);
    }
}
